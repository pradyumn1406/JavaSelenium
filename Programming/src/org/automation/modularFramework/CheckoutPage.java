...
public class CheckoutPage {
	//Declaratization
	@FindBy(id = "BillingNewAddress_CountryId") private WebElement countryID;
	@FindBy(id = "billing-address-select") private WebElement newAddress;
	@FindBy(id = "BillingNewAddress_City") private WebElement cityTB;
	@FindBy(id = "BillingNewAddress_Address1") private WebElement adress1TB;
	...
	@FindBy(xpath = "//input[@value='Continue' and @onclick=\"Billing.save()\"]") private WebElement adressContinue;
	@FindBy(xpath = "//input[@onclick='Shipping.save()']") private WebElement shippingAdressContinue;
	@FindBy(xpath = "//input[@onclick='ShippingMethod.save()']") private WebElement shippingMethod;
	@FindBy(xpath = "//input[@onclick='PaymentMethod.save()']") private WebElement paymentMethod;
	@FindBy(xpath = "//input[@onclick='PaymentInfo.save()']") private WebElement paymentInfo;
	@FindBy(xpath = "//input[@onclick='ConfirmOrder.save()']") private WebElement confirmOrder;
	...
	SelectUtility sel = new SelectUtility();
	sel.selectByVisibleTextM(countryID, "India");
